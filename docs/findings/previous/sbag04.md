See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21686380){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21686380";
  const filename = "Findings from SBAG 4b_Apr21_2011_Decadal_Assessment.pdf";
