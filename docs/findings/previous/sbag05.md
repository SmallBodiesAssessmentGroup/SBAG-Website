See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21686463){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21686463";
  const filename = "Findings from SBAG 5_Aug25-26_2011.pdf";
