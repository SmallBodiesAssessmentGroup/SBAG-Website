See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705255){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705255";
  const filename = "Findings from SBAG 18_Jan17-18_2018.pdf";
