See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705099){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705099";
  const filename = "Findings from SBAG 12_Jan6-7_2015.pdf";
