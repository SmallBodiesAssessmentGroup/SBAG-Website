See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706176){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706176";
  const filename = "Findings from SBAG 25_Jun7-8_2021.pdf";
