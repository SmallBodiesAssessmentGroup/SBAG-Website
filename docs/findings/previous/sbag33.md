See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706386){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706386";
  const filename = "Findings from SBAG 33_Jun24-25_2025.pdf";
