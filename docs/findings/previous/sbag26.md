See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706211){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706211";
  const filename = "Findings from SBAG 26_Jan24-25_2022.pdf";
