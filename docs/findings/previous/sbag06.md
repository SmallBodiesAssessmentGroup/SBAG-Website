See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21704977){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21704977";
  const filename = "Findings from SBAG 6_Jan17-18_2012.pdf";
