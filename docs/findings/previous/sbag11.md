See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705084){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705084";
  const filename = "Findings from SBAG 11_Jul29-31_2014.pdf";
