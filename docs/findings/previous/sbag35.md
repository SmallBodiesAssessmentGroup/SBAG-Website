See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21725033){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21725033";
  const filename = "SBAG 35 - Final Community Statements.pdf";
