See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706298){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706298";
  const filename = "Findings from SBAG 30_Jan30-1_2024.pdf";
