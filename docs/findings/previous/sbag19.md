See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705971){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705971";
  const filename = "Findings from SBAG 19_Jun13-14_2018.pdf";
