See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705060){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705060";
  const filename = "Findings from SBAG 10_Jan8-9_2014.pdf";
