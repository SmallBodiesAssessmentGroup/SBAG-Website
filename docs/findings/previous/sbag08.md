See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705024){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705024";
  const filename = "Findings from SBAG 8_Jan14-16_2013.pdf";
