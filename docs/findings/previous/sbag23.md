See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706068){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706068";
  const filename = "Findings from SBAG 23_Jun1-2_2020.pdf";
