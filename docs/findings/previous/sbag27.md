See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706226){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706226";
  const filename = "Findings from SBAG 27_Jun7-9_2022.pdf";
