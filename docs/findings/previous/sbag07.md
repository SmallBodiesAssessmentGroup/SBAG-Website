See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21704993){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21704993";
  const filename = "Findings from SBAG 7_Jul10-11_2012.pdf";
