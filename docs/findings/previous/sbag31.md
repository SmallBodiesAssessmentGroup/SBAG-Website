See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706353){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706353";
  const filename = "Findings from SBAG 31_Jul11-12_2024.pdf";
