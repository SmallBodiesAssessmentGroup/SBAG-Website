See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706018){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706018";
  const filename = "Findings from SBAG 21_Jun24-25_2019.pdf";
