See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21684329){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21684329";
  const filename = "Findings from SBAG 1_Jan11-12_2009.pdf";
