See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705043){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705043";
  const filename = "Findings from SBAG 9_Jul10-11_2013.pdf";
