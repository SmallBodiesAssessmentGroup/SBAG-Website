See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705219){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705219";
  const filename = "Findings from SBAG 16_Jan11-13_2017.pdf";
