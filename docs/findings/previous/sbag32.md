See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706362){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706362";
  const filename = "Findings from SBAG 32_Jan7-9_2025.pdf";
