See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705110){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705110";
  const filename = "Findings from SBAG 13_Jun29-1_2015.pdf";
