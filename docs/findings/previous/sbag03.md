See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21686328){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21686328";
  const filename = "Findings from SBAG 3_Aug3-4_2010.pdf";
