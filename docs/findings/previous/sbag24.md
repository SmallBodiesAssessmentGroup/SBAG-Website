See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706163){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706163";
  const filename = "Findings from SBAG 24_Jan26-27_2021.pdf";
