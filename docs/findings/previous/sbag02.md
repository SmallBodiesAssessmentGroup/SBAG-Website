See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21686088){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21686088";
  const filename = "Findings from SBAG 2_Nov18-19_2009.pdf";
