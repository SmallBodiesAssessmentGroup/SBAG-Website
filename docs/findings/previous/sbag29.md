See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706269){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706269";
  const filename = "Findings from SBAG 29_Jun11-13_2023.pdf";
