See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706256){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706256";
  const filename = "Findings from SBAG 28_Jan24-25_2023.pdf";
