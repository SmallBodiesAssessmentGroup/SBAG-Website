See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706002){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706002";
  const filename = "Findings from SBAG 20_Jan29-31_2019.pdf";
