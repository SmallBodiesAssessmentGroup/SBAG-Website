See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21705204){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21705204";
  const filename = "Findings from SBAG 15_Jun28-30_2016.pdf";
