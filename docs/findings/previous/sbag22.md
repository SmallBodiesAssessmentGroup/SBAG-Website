See findings and complete materials from the meeting on [Zenodo](https://zenodo.org/records/21706040){ target="_blank" }.
...
<script>
{
  ...
  const recordId = "21706040";
  const filename = "Findings from SBAG 22_Jan14-16_2020.pdf";
